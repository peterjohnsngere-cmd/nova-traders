...
const ManualTrader = () => {
     ...
     * percentages.
     *
     * The displayed values always add up
     * to exactly 100%.
     */
     ...
     * MARKET DATA
     *
     * First request the latest 100 historical
     * ticks so the digit analyzer starts with
     * a real 100-tick sample.
     *
     * After that, subscribe to live ticks and
     * maintain the rolling 100-tick window.
     */
    useEffect(() => {
        ...
        const subscribe = async () => {
            try {
                 ...
                 *
                 * This is a one-time historical
                 * request and does not create a
                 * live subscription.
                 */
                ...
                /*
                 * Start the live tick stream only
                 * after the historical sample has
                 * been loaded.
                 */
                const response =
                    await api_base.api.send({
    ...
    useEffect(() => {
        ...
        const subscription = api_base.api
            ...
            .subscribe(({ data }: any) => {
                ...
                /*
                 * Rebuild the distribution from
                 * the exact current 100-tick window.
                 */
                setDigitCounts(
                    buildDigitCounts(
                        history
