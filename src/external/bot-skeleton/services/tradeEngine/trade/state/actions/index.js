...
dispatch,
getState,
data: { type: constants.START },
scope: constants.STOP,
});

export const proposalsReady = () => ({
type: constants.PROPOSALS_READY,
});

export const clearProposals = () => ({
type: constants.CLEAR_PROPOSALS,
});

const dispatchIfScopeIsBeforePurchase = args =>
dispatchIfScopeIs({
...args,
...
dispatch,
getState,
data: { type: constants.PURCHASE_SUCCESSFUL },
});
...
dispatchIfBeforePurchaseReady({
    dispatch,
    getState,
    data: { type: constants.OPEN_CONTRACT },
});
```
...
dispatch,
getState,
data: { type: constants.SELL },
scope: constants.DURING_PURCHASE,
});

export const tradeAgain = () => ({
type: constants.TRADE_AGAIN,
});
